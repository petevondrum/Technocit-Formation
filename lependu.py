# En utilisant char qui est une variable temporaire utile ds la comprehension de liste pour extraire les occurences de la lettre 
# devinée ds le mot à trouver. enumerate(mot_à_trouver): cette fonction énumère les caratère du mot 
# mot_à_trouver avec leur indice associé. cela renvoie des tuples de la forme (indice, caractère).
...
#         print("Bien deviné!")
#         indices = [i for i, lettre_mot in enumerate(mot_à_trouver) if lettre_mot == lettre]
